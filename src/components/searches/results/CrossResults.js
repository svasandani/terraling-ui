...
const CrossLingPropertyResults = ({
  data,
  resultData,
  nameSort,
  countSort,
  ...
  return (
    <>
      <h1>
        Crossing {resultData.ling_properties.length}{" "}
        {CapitalCase(data.overviewData.ling0_name)} propert
        {resultData.ling_properties.length === 1 ? "y" : "ies"}:{" "}
        {resultData.ling_properties.join(", ")}
      </h1>
...
const CrossLingletPropertyResults = ({
  data,
  resultData,
  nameSort,
  countSort,
  ...
  return (
    <>
      <h1>
        Crossing {resultData.linglet_properties.length}{" "}
        {CapitalCase(data.overviewData.ling1_name)} propert
        {resultData.linglet_properties.length === 1 ? "y" : "ies"}:{" "}
        {resultData.linglet_properties.join(", ")}
      </h1>
      {resultData.property_combinations.length === 0 ? (
        <>
          <h2>No results found!</h2>
